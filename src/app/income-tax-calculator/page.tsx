      ...
      {result && (
        <div className="hidden print:block print-exact">
          ...
          <div className="px-8 py-6">
            ...
            <p className="mt-6 text-[11px] leading-relaxed text-gray-500 border-t border-gray-200 pt-4">
              <strong>Disclaimer:</strong> This computation is generated by Taxaltus, a non-profit tax-education initiative, for
              educational and informational purposes only and does not constitute tax advice. It is an estimate for a resident
              individual under {rules.label} ({rules.fyLabel}) and does not model non-residents, AMT, the 15% surcharge cap on
              dividends, clubbing of others’ income, or inter-year loss carry-forward. Please verify against your Form 16,
              AIS/Form 26AS, the latest official rules at incometax.gov.in, and consult a qualified Chartered Accountant before
              filing. © {new Date().getFullYear()} Taxaltus.
            </p>
          </div>
        </div>
      )}
