...
export const glossary: GlossaryTerm[] = [
  ...
  },
  {
    ...
    longDef: "Standard Deduction is a flat deduction available to salaried individuals and pensioners from their gross salary or pension income. Under the new tax regime, it is 75,000 (from FY 2024-25). Under the old regime, it is 50,000. This replaced the earlier transport and medical allowance exemptions.",
  ...
  },
  {
    ...
    longDef: "Section 87A provides a rebate to resident individuals whose total taxable income does not exceed specified limits. Under the new tax regime (FY 2024-25), a rebate of up to 25,000 is available if total income is up to 7,00,000. Under the old regime, the rebate is up to 12,500 for income up to 5,00,000.",
    example: "If total taxable income under new regime is 6,80,000, the tax calculated might be 26,000 but the rebate of 25,000 reduces effective tax to 1,000 plus cess.",
    whereYouSeeIt: "Form 16 Part B, ITR",
...
export const form16Fields: Form16Field[] = [
  ...
  },
  {
    ...
    specimenKey: "3",
    partLabel: "Part B",
    description: "A flat deduction available to all salaried employees and pensioners. No bills or proof required. Under the new regime (FY 2024-25), it is 75,000. Under the old regime, it is 50,000.",
    ...
    calculation: "Flat amount: 75,000 (new regime, FY 2024-25 onwards) or 50,000 (old regime). If salary income is less than this amount, deduction is limited to salary income.",
  ...
  },
  {
    ...
    calculation: "Under New Regime (FY 2024-25): 0-3L: Nil, 3-7L: 5%, 7-10L: 10%, 10-12L: 15%, 12-15L: 20%, Above 15L: 30%.",
  ...
  },
  {
    ...
    specimenKey: "10",
    partLabel: "Part B",
    description: "A tax rebate available to resident individuals. Under the new regime, if total income is up to 7,00,000, a rebate of up to 25,000 is available. Under the old regime, it is up to 12,500 for income up to 5,00,000.",
    whyItMatters: "For lower-income earners, this rebate can effectively make their tax liability zero or near-zero.",
    calculation: "Rebate = Lower of (actual tax on total income) or (25,000 under new regime / 12,500 under old regime). Available only if taxable income is within the prescribed limit.",
...
export const sections: Section[] = [
  ...
  },
  {
    ...
    explanation: "Standard deduction is a flat deduction from salary income. It was introduced in 2018 to replace transport and medical allowance exemptions. From FY 2024-25, it is 75,000 under the new tax regime and 50,000 under the old regime. No proof or bills required.",
...
export const quizzes: Quiz[] = [
  ...
  {
    id: "q6",
    question: "What is the Standard Deduction amount under the new tax regime (FY 2024-25)?",
    options: ["50,000", "75,000", "1,00,000", "No standard deduction under new regime"],
    answerIndex: 1,
    explanation: "From FY 2024-25, the standard deduction under the new tax regime has been increased to 75,000 (from 50,000 earlier). Under the old regime, it remains at 50,000.",
